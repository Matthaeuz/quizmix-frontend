...
class _RestClient implements RestClient {
  ...
  Future<List<QuestionAttempt>> getQuestionAttemptsByQuiz(
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/question_attempts/?attempt__quiz__id=${quizId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<JSONResponse> sendCode(Map<String, dynamic> email) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/forgot_password/send_verification_code/',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<JSONResponse> verifyCode(Map<String, dynamic> userDetails) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(userDetails);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<JSONResponse>(Options(
      method: 'POST',
      headers: _headers,
  ...
  @override
  Future<JSONResponse> changePassword(Map<String, dynamic> userDetails) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
