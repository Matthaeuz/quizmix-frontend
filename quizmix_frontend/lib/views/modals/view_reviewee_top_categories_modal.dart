...
class ViewRevieweeTopCategoriesModal extends ConsumerStatefulWidget {
  const ViewRevieweeTopCategoriesModal({Key? key}) : super(key: key);

  @override
  ConsumerState<ViewRevieweeTopCategoriesModal> createState() =>
      _ViewRevieweeTopCategoriesModalState();
}

class _ViewRevieweeTopCategoriesModalState
    extends ConsumerState<ViewRevieweeTopCategoriesModal> {
  @override
