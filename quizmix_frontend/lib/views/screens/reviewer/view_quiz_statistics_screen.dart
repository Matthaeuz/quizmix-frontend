...
import 'package:quizmix_frontend/views/modals/view_all_quiz_attempts_modal.dart';
...
// Generate DataColumn widgets for the current page
    ...
    return Stack(
      children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            if (!ref
                                .watch(allQuestionAttemptsProvider)
                                .maybeWhen(
                                  loading: () => true,
                                  orElse: () => false,
                                ))
                                        ...
                                        ElevatedButton(
                                          onPressed: () {
                                            if (currentPage > 0) {
                                              ...
                                              ref
                                                  .read(
                                                      dataRowsProvider.notifier)
                                                  .updateDataRows(newRows);
                                              ref
                                                  .read(dataColumnsProvider
                                                      .notifier)
                                                  .updateDataColumns(
                                                      newColumns);
                                            }
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: () {
                                      ref
                                          .read(modalStateProvider.notifier)
                                          .updateModalState(
                                              ModalState.viewAllQuizAttempts);
                                    },
                                  ...
                                  DropdownButton<String>(
                                    ...
                                    value: ref.watch(orderByProvider)
                                        ? 'asc'
                                        : 'desc',
                                    items: const [
                                      DropdownMenuItem(
                              ...
                              attempts.when(
                                data: (data) {
                                  ...
                                  if (sortBy == 'reviewee') {
                                    ...
                                    sortedAttempts.sort((a, b) => a
                                        .timeFinished!
                                        .compareTo(b.timeFinished!));
                                  } else if (sortBy == 'score') {
                                    sortedAttempts.sort((a, b) => a.attemptScore
                                        .compareTo(b.attemptScore));
                                  }
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            child:
                                                QuizStatisticsAttemptsContainer(
                                              attempt: attempt,
        ...
        ] else if (modalState == ModalState.viewAllQuizAttempts) ...[
          Container(
            color: AppColors.fourthColor.withOpacity(0.8),
            child: const ViewAllQuizAttemptsModal(),
          ),
        ]
      ],
    );
